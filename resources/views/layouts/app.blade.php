...
<body class="h-screen flex bg-gray-100 dark:bg-dark transition-colors duration-300">
    <!-- Sidebar -->
    <div class="fixed flex flex-col top-0 left-0 w-64 bg-white dark:bg-dark h-full border-r dark:border-gray-700 transition-colors duration-300">
        <!-- Header Sidebar -->
        <div class="flex items-center justify-center h-14 border-b dark:border-gray-700">
    ...
    <!-- Main Content -->
    <div class="flex-1 ml-64 p-6 transition-colors duration-300">
        <!-- Tombol Dark Mode -->
